...
namespace Questao1 {
    class Program {
        ...
        public static void printConta(ContaBancaria conta)
        {
            Console.WriteLine("Conta:" + conta.getConta().ToString() + ", Titular:" + conta.getTitular() + ", Saldo: $ " + conta.getSaldo().ToString());
        }
    }
}
